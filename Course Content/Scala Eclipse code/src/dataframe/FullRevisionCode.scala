...
object FullRevisionCode {
  ...
  def main(args: Array[String]): Unit = {
    ...
    System.setProperty("hadoop.home.dir", "D:\\hadoop") // change your path accordingly for winutils
    println("====started==")
    ...
    val parquetdf = spark.read.load("file:///C:/data/revdata/file5.parquet").select(listcol.map(col): _*)
    parquetdf.show(5)
